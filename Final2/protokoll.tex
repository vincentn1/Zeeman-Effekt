...
=\lambda 2f^2((R)^2−r^2) $
mit\\
$ \frac {R^2} {2f^2} ≃0 $ für R<<f gilt: Δ$\Delta\lambda = \lambda/ 2f^2 ⋅ (R^2−r^2)$ Daraus ergibt sich die Frequenzverschiebung 
$\Delta υ=\frac{c}{\lambda}))-\frac{c}{\lambda+\Delta\lambda})) ≃c\delta \lambda/ \lambda^2$ 
