...
berechnen. Die Rechnung kann sich anhand von Abbildung \ref{rechnungatomabstand}, in der die hexagonale Struktur Grafits dargestellt ist, klargemacht werden. Unser Wert stimmt mit dem dritten Fehlerintervall mit dem theoretischen Wert überein. Hätten wir die Standardabweichung als Fehler genommen, wurde unser Wert 11 Fehlerintervalle von dem theoretischen abweichen.
