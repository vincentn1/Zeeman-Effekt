...
In \ref{steigungnu} kann sehen, dass wenn die Frequenzaufspaltung des Zeeman-Effekts gegen die Stärke des Magnetfelds aufgetragen wird, durch die Steigung der sich dadurch ergebenen Geraden der Lande-Faktor $g_j$ bestimmt werden kann. Ist die Steigung der Geraden $m$, so ist der Lande-Faktor gegeben durch

\begin{equation}
g_j = \frac{m \cdot h}{\mu_B}
\end{equation}
